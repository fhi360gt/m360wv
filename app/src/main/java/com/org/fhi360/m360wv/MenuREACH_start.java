...
public class MenuREACH_start extends ActionBarActivity implements View.OnClickListener {
...
//        btnDashboard.setOnClickListener(this);
        ...
        bluetoothAdmin.setOnDataReceivedListener(new BluetoothSPP.OnDataReceivedListener() {
            ...
            public void onDataReceived(byte[] bytes, String s) {
                ...
                test.createAndSaveDB(MenuREACH_start.this);
            }
        });
    ...
    private void initBT() {
        ...
        Toast.makeText(MenuREACH_start.this, "Waiting for information....", Toast.LENGTH_LONG).show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == BluetoothState.REQUEST_CONNECT_DEVICE) {
            ...
            if (resultCode == Activity.RESULT_OK) {
                bluetoothAdmin.setupService();
                bluetoothAdmin.startService(BluetoothState.DEVICE_ANDROID);
                Toast.makeText(MenuREACH_start.this, "Waiting for information again....", Toast.LENGTH_LONG).show();
            } else {
    ...
    public void setSelector(int selector) {
        ...
        switch (selector) {
            case 1:
                ...
                Intent intent1 = new Intent(MenuREACH_start.this, MainSelectActivity.class);
            ...
            case 2:
                ...
                //selectComposite.setVisibility(View.INVISIBLE);
                //selectDashboard.setVisibility(View.INVISIBLE);
                Intent intent2 = new Intent(MenuREACH_start.this, MainSelectActivity.class);
            ...
            case 3:
                ...
                //selectComposite.setVisibility(View.INVISIBLE);
                //selectDashboard.setVisibility(View.INVISIBLE);
                Intent intent3 = new Intent(MenuREACH_start.this, MainSelectActivity.class);
            ...
            case 4:
                ...
                //selectDashboard.setVisibility(View.INVISIBLE);
                Intent intent4 = new Intent(MenuREACH_start.this, MainSelectActivity.class);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_collect:
                Intent intent1 = new Intent(MenuREACH_start.this, CollectSelectActivityNEW.class);
                startActivity(intent1);
                break;
...
//                Bundle gi1 = new Bundle();
//                gi1.putString("groupIndicator", "Time to learn");
//                intent2.putExtras(gi1);
//                startActivity(intent2);
                Intent intent2 = new Intent(MenuREACH_start.this, REACHIndicatorActivity.class);
                Bundle b = new Bundle();
                b.putString("nombre_indicador", "Official School Days");
                intent2.putExtras(b);
                startActivity(intent2);
