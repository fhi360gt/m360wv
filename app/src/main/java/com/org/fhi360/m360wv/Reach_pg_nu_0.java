...
public class Reach_pg_nu_0 extends FragmentActivity {
    ...
    private void initialisePaging() {
        ...
        fragments.add(Fragment.instantiate(this, Reach_pg_nu_1.class.getName()));
        fragments.add(Fragment.instantiate(this, Reach_pg_nu_2.class.getName()));
