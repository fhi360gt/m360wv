...
public class Reach_pg_he_0 extends FragmentActivity {
    ...
    private void initialisePaging() {
        ...
        fragments.add(Fragment.instantiate(this, Reach_pg_he_1.class.getName()));
        fragments.add(Fragment.instantiate(this, Reach_pg_he_2.class.getName()));
